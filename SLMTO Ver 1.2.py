...
input(Fore.GREEN + Style.BRIGHT + "머스크형의 행운을 담아 다섯 세트 생성 enter!\n")

# 45 이하의 숫자 행운숫자 x개 생성(x=행운숫자)
numbers = [random.randint(1, 45) for _ in tqdm(
    range(19710628), leave=True, bar_format='{l_bar}{bar:45}|')]  # barformat로 진행바 표시시 불필요한것들 삭제
...
input(Fore.RED + Style.BRIGHT + "\n머스크형의 기운을 담은 후 enter!" + Style.RESET_ALL)
